...
const CATEGORY_COLORS = {
  'Cash from FO': '#16a34a',
  'GPay Received': '#7c3aed',
  'Cash from Bank': '#0891b2',
  'Vegetables': '#dc2626',
  'Groceries': '#dc2626',
  'Milk & Dairy': '#dc2626',
  'Cleaning Supplies': '#d97706',
  'Maintenance': '#d97706',
  'Transport': '#d97706',
  'Utilities': '#d97706',
  'Wages': '#dc2626',
...
export default function HrCashLedgerPage() {
  const api = useApi();
  ...
  const fetchLedger = async () => {
    try {
      setLoading(true);
      const res = await api.get(`/expenses/hr-cash-ledger?from=${from}&to=${to}`);
      setData(res.data);
    } catch (err) {
    ...
    <>
      <div className="d-print-none mb-3 d-flex justify-content-between align-items-center flex-wrap gap-2">
        <h5 className="mb-0 fw-bold">
          <i className="bi bi-receipt me-2 text-danger"></i>HR Cash Ledger
        </h5>
      ...
      {data?.summary && (
        <div className="row g-3 mb-3">
          ...
          <div className="col-md-3">
            <div className="card border-0 shadow-sm">
              <div className="card-body">
                <div style={{ fontSize: 11, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 1 }}>Total Received</div>
          ...
          <div className="col-md-3">
            <div className="card border-0 shadow-sm">
              <div className="card-body">
                <div style={{ fontSize: 11, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: 1 }}>Total Spent</div>
      ...
      <div className="card border-0 shadow-sm" style={{ borderRadius: 12 }}>
        <div className="card-body p-0">
          {loading ? (
            ...
            <div className="text-center py-5 text-muted">No HR transactions found for this period</div>
          ) : (
